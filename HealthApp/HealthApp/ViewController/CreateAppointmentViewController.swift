...
class CreateAppointmentViewController: UIPageViewController {
    ...
    lazy var orderedControllers: [UIViewController] = {
        return [
            newViewController(storyboardIdentifier: "patientListVC"),
            newViewController(storyboardIdentifier: "saveAppointmentVC"),
            newViewController(storyboardIdentifier: "finalStepVC"),
